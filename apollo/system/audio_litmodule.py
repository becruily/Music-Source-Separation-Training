...
class AudioLightningModule(pl.LightningModule):
    def __init__(
        ...
        print(f'Accum batches: {self.accum_batches}')
        self.total_steps = 0
    ...
    def validation_step(self, batch, batch_nb):
        ...
        sf.write('Exps/valid.wav', est_sources.cpu()[0].T, 44100)
